...
@Component({
  selector: 'app-regist-compent',
  templateUrl: './regist-compent.component.html',
  styleUrls: ['./regist-compent.component.css']
})
export class RegistCompentComponent implements OnInit {
  ...
  getCaptcha(e: MouseEvent) {
    let url= port.BASE_URL+name.user_register_code,keys;
  ...
  toAdd(){
    let url= port.BASE_URL+name.user_register,keys;
    if(this.item == 0){
      keys = {
        type:0,
        mobile:this.validateForm.value.phoneNumber,
