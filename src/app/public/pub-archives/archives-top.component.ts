...
@Component({
  ...
  template: `
    ...
    <ng-template #modalContent>
      <app-regist-compent *ngIf = "key=='1'" [(issucess)]="key" (succeed)="showModal('0','登录')" ></app-regist-compent>
      ...
      <app-fogot-pwd-component *ngIf = "key=='2'"  [(issucess)]="key" (succeed)="showModal('0','登录')" ></app-fogot-pwd-component>
...
<div class="showTop">
  <div class="mainBox">
    <a *ngIf ="ifs==true" routerLink="/public" ><img src="./assets/images/logo3.jpg"></a>
    <a *ngIf ="ifs==false" routerLink="/public" ><img src="./assets/images/logo9.jpg"></a>
    <a *ngIf ="ifs2==true" routerLink="/public" ><img src="./assets/images/logo3.jpg"></a>
    <div class="topBtn">
     ...
     <a  *ngIf="changeKey==true" class="go" (click)="showModal('0','登录')">登录</a>
     <a  *ngIf="changeKey==true" class="reg" (click)="showModal('1','注册')">注册</a>
    </div>
  </div>
</div>
<div *ngIf ="ifs==true" class="showBanner"></div>
<div *ngIf ="ifs==false" class="showBanners"></div>
<div *ngIf ="ifs2==true" class="showBannerc" ></div>
  `,
  styles: [`
.mainBox .topBtn {
  position: absolute;
...
.showBannerc {
  width: 100%;
  background: url(./assets/images/49.jpg) no-repeat center center;
  height: 207px
}
...
export class Archives_topComponent {
