...
@Component({
  selector: 'propaganda-detail',
  templateUrl: './propaganda-detail.component.html',
  styleUrls: ['./propaganda-detail.component.css']
})
export class propagandadetailComponent implements OnInit{
  ...
  toSee(key,url,id,size,limit){
   ...
   ngOnInit() {     window.scrollTo(0, 0);
    ...
    let url = port.BASE_URL+name.exhibition_get;
    if(this.userId==null){
      this.userId = ""
    }
